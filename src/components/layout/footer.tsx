...
const Logo = () => (
    <div className="flex flex-col items-start">
        <span className="font-headline text-3xl font-bold text-background tracking-wider">aünthram</span>
        <span className="text-xs font-medium text-background/70 tracking-[0.2em]">LEADERSHIP ACADEMY</span>
    </div>
);
...
export default function Footer() {
  return (
    <>
      <section className="bg-background text-background py-16">
        <div className="container mx-auto px-4 md:px-6 text-center">
            <h2 className="text-2xl md:text-3xl font-headline max-w-4xl mx-auto text-foreground">
